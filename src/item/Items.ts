...
export class Items {
    ...
    public static readonly BOMB_WEAPON = this.register("bomb_weapon", new BombWeapon(new Item.Properties()
        .maxCooldown(800)
    ...
    public static readonly FOCUSED_ARC_EMITTER = this.register("focused_arc_emitter", new FocusedArcEmitter(new Item.Properties()
        .attackDamage(48)
        .maxCooldown(32)
        .type(WeaponType.ENERGY, WeaponType.ARC)
        .unbreakable()
    ...
    public static readonly ARTILLERY125 = this.register("artillery125", new Artillery125(new Item.Properties()
        .maxDurability(8)
        .attackDamage(12)
        .maxCooldown(32)
        .type(WeaponType.KINETIC, WeaponType.EXPLOSIVE)
    ...
    public static readonly POINT_DEFENSE = this.register("point_defense", new PointDefense(new Item.Properties()
    ...
    public static readonly COILGUN = this.register("coilgun", new Coilguns(new Item.Properties()
        .maxDurability(50)
        .attackDamage(5)
        .maxCooldown(3)
        .type(WeaponType.KINETIC)
    ...
    public static readonly RAILGUN = this.register("railgun", new RailGun(new Item.Properties()
        .maxDurability(40)
        .attackDamage(16)
        .maxCooldown(5)
        .type(WeaponType.KINETIC)
    ...
    public static readonly KINETIC_ARTILLERY = this.register("kinetic_artillery", new KineticArtillery(new Item.Properties()
        .maxDurability(32)
        .attackDamage(32)
        .maxCooldown(24)
        .type(WeaponType.KINETIC)
    ...
    public static readonly SPACE_TORPEDOES = this.register("space_torpedoes", new SpaceTorpedoes(new Item.Properties()
        .attackDamage(16)
        .maxCooldown(400)
        .type(WeaponType.KINETIC, WeaponType.EXPLOSIVE)
    ...
    public static readonly GAMMA_LASERS = this.register('gamma_lasers', new GammaLasers(new Item.Properties()
        .attackDamage(12)
        .maxCooldown(20)
        .unbreakable()
        .type(WeaponType.ENERGY)
    ));
    public static readonly PARTICLE_LANCE = this.register('particle_lance', new ParticleLance(new Item.Properties()
        .attackDamage(20)
        .maxCooldown(36)
        .unbreakable()
        .type(WeaponType.ENERGY)
    ));
    public static readonly TACHYON_LANCE = this.register('tachyon_lance', new TachyonLance(new Item.Properties()
        .attackDamage(40)
        .maxCooldown(36)
        .unbreakable()
        .type(WeaponType.ENERGY)
    ));
    public static readonly PERDITION_BEAM = this.register('perdition_beam', new PerditionBeam(new Item.Properties()
        .attackDamage(100)
        .type(WeaponType.ENERGY)
    ...
    public static readonly TORPEDO_LAUNCHER = this.register('torpedo_launcher', new TorpedoLauncher(new Item.Properties()
        .attackDamage(1)
        .type(WeaponType.EXPLOSIVE)
        .maxDurability(12)
        .maxCooldown(6)
