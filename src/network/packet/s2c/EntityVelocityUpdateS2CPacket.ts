...
export class EntityVelocityUpdateS2CPacket implements Payload {
    public static readonly ID: PayloadType<EntityVelocityUpdateS2CPacket> = payloadType('entity_velocity');
    ...
    private constructor(entityId: number, velocityXInt16: number, velocityYInt16: number) {
    ...
    public type(): PayloadType<EntityVelocityUpdateS2CPacket> {
