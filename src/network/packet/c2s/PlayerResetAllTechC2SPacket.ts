...
export class PlayerResetAllTechC2SPacket implements Payload {
    ...
    public static readonly ID: PayloadType<PlayerResetAllTechC2SPacket> = payloadType('player_reset_all_tech');
    public static readonly CODEC: PacketCodec<PlayerResetAllTechC2SPacket> = PacketCodecs.uint(this.INSTANCE);

    private constructor() {
    }

    public type(): PayloadType<PlayerResetAllTechC2SPacket> {
